...
function App() {
  ...
  const { entries, addEntry, editEntry: updateEntry, deleteEntry, resetAll, importEntries } = useLocalStorage()
  ...
  return (
    <div className="flex w-full min-h-screen bg-[#0f1117]">
      ...
      <main className="flex-1 px-4 md:px-8 py-6 pb-24 md:pb-6 overflow-y-auto max-w-screen-xl">
        ...
        {page === 'settings' && (
          <Settings entries={entries} onImport={importEntries} onReset={resetAll} />
        )}
      </main>
